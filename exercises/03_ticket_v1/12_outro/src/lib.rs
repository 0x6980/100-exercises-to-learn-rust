...
impl Order {
    fn validation_product_name(product_name: &String) {
    ...
    pub fn set_product_name(&mut self, new_product_name: String) {
        Self::validation_product_name(&new_product_name);
        self.product_name = new_product_name
    }

    pub fn set_quantity(&mut self, new_quantity: u32) {
        Self::validation_quantity(&new_quantity);
        self.quantity = new_quantity
    }

    pub fn set_unit_price(&mut self, new_unit_price: u32) {
        Self::validation_unit_price(&new_unit_price);
